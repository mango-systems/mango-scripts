...
if not os.path.exists(f"gpg_signatures/{KEY_NAME}.asc"):
    try:
...
for script_file in script_files:
    ...
    try:
        subprocess.check_output(["gpg", "--sign", "--local-user", KEY_NAME, "-o", signature_path, script_path], universal_newlines=True)
    except subprocess.CalledProcessError as e:
